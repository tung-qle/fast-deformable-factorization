...
if __name__ == "__main__":
    ...
    for rank in matrix_rank:
        ...
        for size in matrix_size:
            ...
            for _ in range(n_trials):
                ...
                m_noise.append((torch.norm(matrix - operator.densification(twiddle_list, min_param)) / torch.norm(matrix)).item())
                print(m_noise[-1])
                ...
                error_perm1_vanilla.append((torch.norm(matrix - operator.densification(factor_list, min_param)) / torch.norm(matrix)).item())
                ...
                error_perm1_normalize.append((torch.norm(matrix - operator.densification(factor_list, min_param)) / torch.norm(matrix)).item())
                ...
                error_perm2_vanilla.append((torch.norm(matrix - operator.densification(factor_list, min_param)) / torch.norm(matrix)).item())
                ...
                error_perm2_normalize.append((torch.norm(matrix - operator.densification(factor_list, min_param)) / torch.norm(matrix)).item())
    ...
    with open(result_path, "wb") as handle:
        pickle.dump([mean_error_list, mean_running_time_list, std_error_list, std_running_time_list, mean_noise], handle, protocol=pickle.HIGHEST_PROTOCOL)
    ...
    for index, (ax1, ax2) in enumerate(ax): 
        ax1.errorbar(matrix_size, mean_running_time_list[index]["perm1_vanilla"], std_running_time_list[index]["perm1_vanilla"], label = r"$\sigma_1$, Algorithm 7", color = 'red', marker = 'o')
        ax1.errorbar(matrix_size, mean_running_time_list[index]["perm1_norm"], std_running_time_list[index]["perm1_norm"], label = r"$\sigma_1$, Algorithm 8", color = 'blue', marker = 'o')
        ax1.errorbar(matrix_size, mean_running_time_list[index]["perm2_vanilla"], std_running_time_list[index]["perm2_vanilla"], label = r"$\sigma_2$, Algorithm 7", color = 'red', marker = 'x')
        ax1.errorbar(matrix_size, mean_running_time_list[index]["perm2_norm"], std_running_time_list[index]["perm2_norm"], label = r"$\sigma_2$, Algorithm 8", color = 'blue', marker = 'x')
        ...
        ax2.errorbar(matrix_size, mean_error_list[index]["perm1_vanilla"], std_error_list[index]["perm1_vanilla"], label = r"$\sigma_1$, Algorithm 7", color = 'red', marker = 'o')
        ax2.errorbar(matrix_size, mean_error_list[index]["perm1_norm"], std_error_list[index]["perm1_norm"], label = r"$\sigma_1$, Algorithm 8", color = 'blue', marker = 'o')
        ax2.errorbar(matrix_size, mean_error_list[index]["perm2_vanilla"], std_error_list[index]["perm2_vanilla"], label = r"$\sigma_2$, Algorithm 7", color = 'red', marker = 'x')
        ax2.errorbar(matrix_size, mean_error_list[index]["perm2_norm"], std_error_list[index]["perm2_norm"], label = r"$\sigma_2$, Algorithm 8", color = 'blue', marker = 'x')
